...
export class TableAJAXService {
  ...
  /**
     ...
     */
    public anprEventsGet(page?: number, where?: string, sort?: string, maxResults?: number, embedded?: string, observe?: 'body', reportProgress?: boolean): Observable<AnprEventsResponse>;
    public anprEventsGet(page?: number, where?: string, sort?: string, maxResults?: number, embedded?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AnprEventsResponse>>;
    public anprEventsGet(page?: number, where?: string, sort?: string, maxResults?: number, embedded?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AnprEventsResponse>>;
    public anprEventsGet(page?: number, where?: string, sort?: string, maxResults?: number, embedded?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (embedded !== undefined && embedded !== null) {
            queryParameters = queryParameters.set('embedded', <any>embedded);
        }
        ...
        return this.httpClient.request<AnprEventsResponse>('get',`${this.basePath}/anprEvents`,
            {
